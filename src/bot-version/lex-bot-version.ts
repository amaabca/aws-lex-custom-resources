...
import { CfnResource, Reference, RemovalPolicy } from 'aws-cdk-lib';
import { LexBotVersionAttributes } from '../lex-data-types';

export default class extends Construct {
  resource: CfnResource;

  constructor(scope: Construct, id: string, serviceToken: string | Reference, props: LexBotVersionAttributes) {
    super(scope, id);

    this.resource = new CfnResource(this, id, {
